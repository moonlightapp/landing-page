    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _TeamMissionComponent = /*#__PURE__*/function () {
        ...
        return _createClass(TeamMissionComponent, [{
          ...
          key: "navigateToTermsOfService",
          value: function navigateToTermsOfService() {
            window.open('https://moonlight.ink/terms-and-conditions', '_blank');
          }
        }, {
          key: "navigateToPrivacyPolicy",
          value: function navigateToPrivacyPolicy() {
